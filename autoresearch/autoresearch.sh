...
# Step 6: Output structured metrics independently for each environment
# Independent decode speeds (primary optimization focus)
...
# Independent number parsing speeds
echo "METRIC luajit_numbers_ms=$luajit_numbers"
echo "METRIC lua52_numbers_ms=$lua52_numbers"
echo "METRIC lua53_numbers_ms=$lua53_numbers"
echo "METRIC lua54_numbers_ms=$lua54_numbers"
echo "METRIC lua55_numbers_ms=$lua55_numbers"

# Independent total times (guarding against regressions)
